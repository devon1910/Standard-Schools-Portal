...
export default function ReportCard({ data, student }: { data: ClassReportData; student: StudentSummary }) {
  ...
  return (
    <article className="report-card">
      ...
      <section className="grade-key"><strong>KEY TO GRADES</strong><div><span>[0–39] = F</span><span>[40–49] = D</span><span>[50–59] = C</span><span>[60–69] = B</span><span>[70–100] = A</span></div></section>
